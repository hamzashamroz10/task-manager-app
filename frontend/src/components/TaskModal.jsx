...
const TaskModal = ({isOpen,onClose, taskToEdit,onSave,onLogout,}) => {
    ...
    },[taskData, today, getHeaders, onLogout, onClose, onSave, onClose])
  ...
  return (
    <div className='fixed inset-0 backdrop:blur-sm bg-black/20 z-50 flex items-center justify-center p-4'>
        <div className=" bg-white border border-purple-100 rounded-xl max-w-md w-full shadow-lg relative p-6 animate">
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                {error && <div className='text-sm text-red-600 bg-red-50 p-3 rounded-lg border border-red-100'>
                    {error}</div>}
                   <div>
                    ...
                    <div className="flex items-center border border-purple-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-offset-purple-500 focus-within:border-purple-500
                    transition-all duration-200">
                        <input type="text" name='title' onChange={handleChange} value={taskData.title} required className='w-full focus:outline-none text-sm' placeholder='Enter task title'/>
                    </div>
                   </div>
                   <div className="">
                    ...
                    <textarea name="description" rows="3"
                     ...
                     className='w-full px-4 py-2.5 border border-purple-100 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-sm' placeholder='Add details about your task'/>
                   </div>
                   ...
                   <button type='submit' disabled={loading} className='w-full bg-gradient-to-r from-fuchsia-500 to-purple-600 text-white font-medium py-2.5 px-4 rounded-lg flex items-center justify-items-center gap-2 disabled:opacity-50 hover:shadow-md transition-all duration-200'>

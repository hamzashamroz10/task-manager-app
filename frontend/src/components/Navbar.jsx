        ...
        <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
            ...
            onClick={()=> navigate('/')}>
                ...
                <div className='relative w-10 h-10 flex items-center justify-center rounded-xl bg-gradient-to-br from-fuchsia-500 via-purple-500 to-indigo-500 shadow-lg group-hover:shadow-purple-300/50 group-hover:scale-105 transition-all duration-300 '>
                    ...
                    <div className='absolute -bottom-1 -middle-1 w-3 h-3 bg-white rounded-xl shadow-md animate-ping '/>
                </div>
                {/* Brand Name */}
                   ...
                   <div ref={menuref} className='relative'>
                    <button onClick={handleMenuToggle} className='flex items-center gap-2 px-3 py-2 rounded-full cursor-pointer hover:bg-purple-50 transition-colors duration-300 border border-transparent hover:border-purple-200'>
                        <div className=' relative'>
                            {user.avatar ? (
                                ...
                                <div className=' w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-br from-fuchsia-500 to bg-purple-600 text-white font-semibold shadow-md'>
                    ...
                    </button>
                    {
                        menuOpen && (
                            ...
                            shadow-xl border border-purple-100
                            ...
                            animate-fadeIn'>
                                ...
                                role='menuitem'>
                                    <Settings className=' w-4 text-gray-700'/>
                                    Profile Setting
                                ...
                                <li className='p-2'>
                                    ...
                                    className='flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm hover:bg-red-50
                                    text-red-600 '>
